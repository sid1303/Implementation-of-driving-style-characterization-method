...
% Setting up environment for the figure
...
% Filter for velocity(0-125 kmph)
...
% Accelerometer graph -3,2,4
        subplot('Position',[0.58, 0.3, 0.38, 0.32 ])
...
% Text on every ride        
        ...
        EfficiencyPrediction = strcat('Predicted Efficiency of the driver : ', char(prediction));
        subplot('Position',[0.55, 0.1, 0.45, 0.1],'Visible','off');
        text(0.5, 0.7, energyPerUnitDist, 'horizontalAlignment', 'center','verticalAlignment','bottom','FontSize',13)
        text(0.5, 0.1, EfficiencyPrediction, 'horizontalAlignment', 'center','verticalAlignment','bottom','FontSize',13,'color','r')
...
% Environment setup for 2nd figure
